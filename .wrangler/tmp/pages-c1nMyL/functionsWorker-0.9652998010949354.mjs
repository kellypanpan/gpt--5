...
// ../.wrangler/tmp/bundle-EVmWla/checked-fetch.js
...
- Keep the tone ${tone} throughout`;
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        max_tokens: length === "long" ? 2e3 : length === "medium" ? 1e3 : 500,
        temperature: 0.7
      })
    });
    const result = await response.json();
...
// ../.wrangler/tmp/pages-c1nMyL/functionsRoutes-0.3322566542180825.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-EVmWla/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-EVmWla/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.9652998010949354.mjs.map
